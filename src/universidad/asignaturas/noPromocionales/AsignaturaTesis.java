...
/**
 * Asignatura de tipo tesis / trabajo final, no promocional.
 * Requiere 75% de asistencia para habilitar.
 */
public class AsignaturaTesis extends AsignaturaNoPromocional {
     ...
     */
    public AsignaturaTesis(String codigo, String nombre, int cuatrimestre) {
        super(codigo, nombre, cuatrimestre, CategoriaAsignatura.TESIS);
    }
